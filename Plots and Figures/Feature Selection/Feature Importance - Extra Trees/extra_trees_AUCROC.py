...
labels[2] = "Class Entropy"
labels[5] = "Feature Entropy"
labels[8] = "Variation Coeff."
labels[-3] = "Signal to Noise Ratio"
labels[-5] = "# Features"
...
with open('//Users/renoslyssiotis/Desktop/When-are-ML-models-required-and-when-is-Statistics-enough-/Plots and Figures/Feature Selection/Feature Importance - Extra Trees/extra_trees_X_AUCROC.pickle', 'wb') as handle:
