...
"""
meta_features = df_results.iloc[:,:12]
...
with open('//Users/renoslyssiotis/Desktop/When-are-ML-models-required-and-when-is-Statistics-enough-/Plots and Figures/Feature Selection/Variance Threshold/var_threshold_zeroVar_X.pickle', 'wb') as handle:
...
with open('//Users/renoslyssiotis/Desktop/When-are-ML-models-required-and-when-is-Statistics-enough-/Plots and Figures/Feature Selection/Variance Threshold/var_threshold_lowVar_X.pickle', 'wb') as handle:
