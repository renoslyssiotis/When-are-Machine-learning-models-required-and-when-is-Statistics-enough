...
results_index = [1,2,3,6,11]

selected_X = df_results.iloc[:, results_index] 

with open('//Users/renoslyssiotis/Desktop/When-are-ML-models-required-and-when-is-Statistics-enough-/Plots and Figures/Feature Selection/Forward Selection/forward_X_AUCPRC.pickle', 'wb') as handle:
