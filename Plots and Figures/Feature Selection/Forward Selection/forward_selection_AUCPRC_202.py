...
results_index = [3, 5, 6, 11, 16, 17, 19, 20]
selected_X = df_results.iloc[:, results_index] 

with open('//Users/renoslyssiotis/Desktop/When-are-ML-models-required-and-when-is-Statistics-enough-/Plots and Figures/Feature Selection/Forward Selection/forward_X_AUCPRC_202.pickle', 'wb') as handle:
