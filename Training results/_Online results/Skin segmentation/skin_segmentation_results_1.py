...
df = pd.read_csv('/Users/renoslyssiotis/Desktop/When-are-ML-models-required-and-when-is-Statistics-enough-/Datasets/Classification/Skin Segmentation/Skin_NonSkin.txt', 
                 sep="\t", 
                 names = ["G","B","R","y"])
