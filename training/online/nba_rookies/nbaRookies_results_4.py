...
# import pickle
# with open(str(p.parents[2])+'/offline/nba_rookies/results_roc_NBA_4.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/nba_rookies/results_prc_NBA_4.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/nba_rookies/results_f1_NBA_4.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/nba_rookies/metafeatures_NBA_4.pickle', 'wb') as handle:
