...
# import pickle
# with open(str(p.parents[2])+'/offline/alcohol/results_roc_alcohol_0.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/alcohol/results_prc_alcohol_0.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/alcohol/results_f1_alcohol_0.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/alcohol/metafeatures_alcohol_0.pickle', 'wb') as handle:
