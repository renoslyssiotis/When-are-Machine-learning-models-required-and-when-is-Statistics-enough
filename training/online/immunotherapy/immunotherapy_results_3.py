...
# import pickle
# with open(str(p.parents[2])+'/offline/immunotherapy/results_roc_immunotherapy_3.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/immunotherapy/results_prc_immunotherapy_3.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/immunotherapy/results_f1_immunotherapy_3.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/immunotherapy/metafeatures_immunotherapy_3.pickle', 'wb') as handle:
