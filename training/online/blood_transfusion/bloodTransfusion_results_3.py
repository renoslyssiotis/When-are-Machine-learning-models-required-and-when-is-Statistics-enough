...
# import pickle
# with open(str(p.parents[2])+'/offline/blood_transfusion/results_roc_blood_3.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/blood_transfusion/results_prc_blood_3.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/blood_transfusion/results_f1_blood_3.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/blood_transfusion/metafeatures_blood_3.pickle', 'wb') as handle:
