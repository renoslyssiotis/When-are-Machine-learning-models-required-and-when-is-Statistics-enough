...
# import pickle
# with open(str(p.parents[2])+'/offline/breast_cancer_coimba/results_roc_coimbra_0.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/breast_cancer_coimba/results_prc_coimbra_0.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/breast_cancer_coimba/results_f1_coimbra_0.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/breast_cancer_coimba/metafeatures_coimbra_0.pickle', 'wb') as handle:
