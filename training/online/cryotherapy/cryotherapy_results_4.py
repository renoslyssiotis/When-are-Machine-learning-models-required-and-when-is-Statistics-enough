...
# import pickle
# with open(str(p.parents[2])+'/offline/cryotherapy/results_roc_cryo_4.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/cryotherapy/results_prc_cryo_4.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/cryotherapy/results_f1_cryo_4.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/cryotherapy/metafeatures_cryo_4.pickle', 'wb') as handle:
