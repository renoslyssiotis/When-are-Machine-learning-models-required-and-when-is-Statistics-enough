...
# import pickle
# with open(str(p.parents[2])+'/offline/vertebral/results_roc_vertebral_3.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/vertebral/results_prc_vertebral_3.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/vertebral/results_f1_vertebral_3.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/vertebral/metafeatures_vertebral_3.pickle', 'wb') as handle:
