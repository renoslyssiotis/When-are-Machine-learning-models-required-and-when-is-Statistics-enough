...
# import pickle
# with open(str(p.parents[2])+'/offline/biodegradation/results_roc_biodegradation_0.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/biodegradation/results_prc_biodegradation_0.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/biodegradation/results_f1_biodegradation_0.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/biodegradation/metafeatures_biodegradation_0.pickle', 'wb') as handle:
