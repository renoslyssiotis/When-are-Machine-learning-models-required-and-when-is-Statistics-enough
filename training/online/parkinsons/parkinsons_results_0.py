...
# import pickle
# with open(str(p.parents[2])+'/offline/parkinsons/results_roc_parkinsons_0.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/parkinsons/results_prc_parkinsons_0.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/parkinsons/results_f1_parkinsons_0.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/parkinsons/metafeatures_parkinsons_0.pickle', 'wb') as handle:
