...
# import pickle
# with open(str(p.parents[2])+'/offline/seeds/results_roc_seeds_2.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/seeds/results_prc_seeds_2.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/seeds/results_f1_seeds_2.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/seeds/metafeatures_seeds_2.pickle', 'wb') as handle:
