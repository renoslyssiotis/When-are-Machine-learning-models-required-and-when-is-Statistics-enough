...
#import pickle
# with open(str(p.parents[2])+'/offline/pulsar_star/results_roc_pulsar_1.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/pulsar_star/results_prc_pulsar_1.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/pulsar_star/results_f1_pulsar_1.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/pulsar_star/metafeatures_pulsar_1.pickle', 'wb') as handle:
