...
#import pickle
# with open(str(p.parents[2])+'/offline/colon_cancer/results_roc_colon_2.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/colon_cancer/results_prc_colon_2.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/colon_cancer/results_f1_colon_2.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/colon_cancer/metafeatures_colon_2.pickle', 'wb') as handle:
