...
# import pickle
# with open(str(p.parents[2])+'/offline/hepatitis/results_roc_hepatitis_3.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/hepatitis/results_prc_hepatitis_3.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/hepatitis/results_f1_hepatitis_3.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/hepatitis/metafeatures_hepatitis_3.pickle', 'wb') as handle:
