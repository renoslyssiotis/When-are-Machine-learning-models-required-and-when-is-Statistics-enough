...
# import pickle
# with open(str(p.parents[2])+'/offline/drug_consumption/results_roc_drug_1.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/drug_consumption/results_prc_drug_1.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/drug_consumption/results_f1_drug_1.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/drug_consumption/metafeatures_drug_1.pickle', 'wb') as handle:
