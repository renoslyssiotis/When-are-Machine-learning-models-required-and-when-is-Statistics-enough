...
# import pickle
# with open(str(p.parents[2])+'/offline/cleveland/results_roc_cleveland_3.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/cleveland/results_prc_cleveland_3.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/cleveland/results_f1_cleveland_3.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/cleveland/metafeatures_cleveland_3.pickle', 'wb') as handle:
