...
# import pickle
# with open(str(p.parents[2])+'/offline/ecoli/results_roc_ecoli_2.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/ecoli/results_prc_ecoli_2.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/ecoli/results_f1_ecoli_2.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/ecoli/metafeatures_ecoli_2.pickle', 'wb') as handle:
