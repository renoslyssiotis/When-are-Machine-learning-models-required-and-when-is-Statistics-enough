...
# import pickle
# with open(str(p.parents[2])+'/offline/breast_cancer/results_roc_breastCancer_4.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/breast_cancer/results_prc_breastCancer_4.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/breast_cancer/results_f1_breastCancer_4.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/breast_cancer/metafeatures_breastCancer_4.pickle', 'wb') as handle:
