...
# import pickle
# with open(str(p.parents[2])+'/offline/mammographic/results_roc_mammographic_3.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/mammographic/results_prc_mammographic_3.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/mammographic/results_f1_mammographic_3.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/mammographic/metafeatures_mammographic_3.pickle', 'wb') as handle:
