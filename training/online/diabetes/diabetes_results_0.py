...
#import pickle
# with open(str(p.parents[2])+'/offline/diabetes/results_roc_diabetes_0.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/diabetes/results_prc_diabates_0.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/diabetes/results_f1_diabates_0.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/diabetes/metafeatures_diabates_0.pickle', 'wb') as handle:
