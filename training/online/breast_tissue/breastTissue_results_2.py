...
# import pickle
# with open(str(p.parents[2])+'/offline/breast_tissue/results_roc_breastTissue_2.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/breast_tissue/results_prc_breastTissue_2.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/breast_tissue/results_f1_breastTissue_2.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/breast_tissue/metafeatures_breastTissue_2.pickle', 'wb') as handle:
