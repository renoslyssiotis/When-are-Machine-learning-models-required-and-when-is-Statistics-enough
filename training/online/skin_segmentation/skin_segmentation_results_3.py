...
# import pickle
# with open(str(p.parents[2])+'/offline/skin_segmentation/results_roc_skin_3.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/skin_segmentation/results_prc_skin_3.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/skin_segmentation/results_f1_skin_3.pickle', 'wb') as handle:
#     pickle.dump(results_f1, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open(str(p.parents[2])+'/offline/skin_segmentation/metafeatures_skin_3.pickle', 'wb') as handle:
