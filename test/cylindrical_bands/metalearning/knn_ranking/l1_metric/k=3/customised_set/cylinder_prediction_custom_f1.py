...
with open(str(p.parents[7])+'/analysis/feature_selection/customised_set/customised_X_f1_202.pickle', 'rb') as handle:
...
#nested_results is a nested dictionary with all the F1 score performances for each dataset and all models
