...
with open(str(p.parents[7])+'/analysis/feature_selection/variance_threshold/var_threshold_zeroVar_X_202.pickle', 'rb') as handle:
...
#Actual results
with open(str(p.parents[5])+'/actual/cylinder_top_3_f1.pickle', 'rb') as handle:
