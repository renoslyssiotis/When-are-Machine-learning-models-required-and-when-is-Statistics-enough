...
with open(str(p.parents[1])+'/actual/cylinder_metafeatures_202.pickle', 'rb') as handle:
...
#==============================================================================    
with open(str(p.parents[3])+'/analysis/dataset_clustering/two_level_clustering/general_clustering_standardised/second_level_clustering/AUC-ROC/subclusters_of_cluster_10.pickle', 'rb') as handle:
...
with open(str(p.parents[1])+'/actual/cylinder_top_3_roc.pickle', 'rb') as handle:
