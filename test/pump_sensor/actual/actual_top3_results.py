...
with open('sensor_metafeatures_202.pickle', 'wb') as handle:
...
# with open('sensor_top_3_roc.pickle', 'wb') as handle:
#     pickle.dump(results_roc, handle, protocol=pickle.HIGHEST_PROTOCOL)
# with open('sensor_top_3_prc.pickle', 'wb') as handle:
#     pickle.dump(results_prc, handle, protocol=pickle.HIGHEST_PROTOCOL)    
# with open('sensor_top_3_f1.pickle', 'wb') as handle:
...
#==============================================================================
#       Run the best model (Random forest) to check its execution time
#==============================================================================   
