...
with open('/Users/renoslyssiotis/Desktop/When-are-ML-models-required-and-when-is-Statistics-enough-/Analysis/Feature Selection/Variance Threshold/var_threshold_lowVar_X_202.pickle', 'rb') as handle:
