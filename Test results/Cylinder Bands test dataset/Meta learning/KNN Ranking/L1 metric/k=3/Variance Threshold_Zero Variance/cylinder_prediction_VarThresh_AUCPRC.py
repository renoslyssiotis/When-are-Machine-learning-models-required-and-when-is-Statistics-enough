import sys
sys.path.append('/Users/renoslyssiotis/Desktop/When-are-ML-models-required-and-when-is-Statistics-enough-/Meta-learners/KNN Ranking Method/L1 metric')
from KNN_ranking_k_3 import KNN_ranking
import pickle

#Load the selected meta-dataset after performing zero-variance threshold
with open('/Users/renoslyssiotis/Desktop/When-are-ML-models-required-and-when-is-Statistics-enough-/Plots and Figures/Feature Selection/Variance Threshold/var_threshold_zeroVar_X_202.pickle', 'rb') as handle:
    metadataset_feature_selected = pickle.load(handle)
    
#=====================META-FEATURE EXTRACTION OF TEST DATASET==================
...
#nested_results is a nested dictionary with all the AUC-PRC performances for each TRAINING dataset and all models
...
#Actual results
with open('/Users/renoslyssiotis/Desktop/When-are-ML-models-required-and-when-is-Statistics-enough-/Test results/Cylinder Bands test dataset/Actual results/cylinder_top_3_prc.pickle', 'rb') as handle:
