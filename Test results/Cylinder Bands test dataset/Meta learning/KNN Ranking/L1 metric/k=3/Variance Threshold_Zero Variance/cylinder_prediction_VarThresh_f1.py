...
#nested_results is a nested dictionary with all the AUC-f1 performances for each TRAINING dataset and all models
...
#Actual results
with open('/Users/renoslyssiotis/Desktop/When-are-ML-models-required-and-when-is-Statistics-enough-/Test results/Cylinder Bands test dataset/Actual results/cylinder_top_3_f1.pickle', 'rb') as handle:
