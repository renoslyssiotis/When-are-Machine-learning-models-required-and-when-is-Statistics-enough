...
with open('/Users/renoslyssiotis/Desktop/When-are-ML-models-required-and-when-is-Statistics-enough-/Analysis/Feature Selection/Forward Selection/forward_X_AUCPRC_202.pickle', 'rb') as handle:
