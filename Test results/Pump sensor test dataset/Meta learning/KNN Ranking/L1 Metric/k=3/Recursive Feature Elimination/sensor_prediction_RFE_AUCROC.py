...
with open('/Users/renoslyssiotis/Desktop/When-are-ML-models-required-and-when-is-Statistics-enough-/Analysis/Feature Selection/Recursive Feature Elimination/RFE_X_AUCROC_202.pickle', 'rb') as handle:
