...
# plt.ylabel("Minimum distance to test dataset", fontsize = 16)
# plt.yticks(fontsize = 14)
# plt.xticks(fontsize = 14)
# # plt.title("Minimum distance of set of trainign  vs. Number of\n training datasets", fontsize = 16, fontweight = 'bold')
# plt.plot(training_datasets, wine_min_distances, c = 'blue', label = 'Wine quality')
# plt.plot(training_datasets, pump_min_distances, c = 'darkorange', label = 'Pump sensor')
